...
listaString.Add("Symon");
listaString.AddRange("Silva", "Lima");
...
// Array.Resize(ref arrayInteiros, 15);
...
// {
//     Console.WriteLine($"Array posição {i}: número armazenado na posição {arrayInteiros[i]}");
// }

// int contador = 0;
// Console.WriteLine("ForEach");
// foreach (int numeros in arrayInteiros)
// {

//     Console.WriteLine($"Array posição {contador}: número armazenado na posição {numeros}");
//     contador++;

// }

// int[] arrayInteiroCopia = new int[15];
// Array.Copy(arrayInteiros, arrayInteiroCopia, arrayInteiros.Length);

// Console.WriteLine("Array Cópia");
// contador = 0;
// foreach (int numerosCopia in arrayInteiroCopia)
// {
//     Console.WriteLine($"Array posição {contador}: número armazenado na posição {numerosCopia}");
//     contador++;
// }
